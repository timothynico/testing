            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    @php
                        ...
                        // Sort: warehouse with most pallets first
                    ...
                    {{-- ── Loop per warehouse ── --}}
                    @foreach ($groupedByWarehouse as $whKey => $wh)
                        <div class="border-bottom">
                            ...
                            {{-- Items table for this warehouse --}}
                            <div class="table-responsive">
                                <table class="table table-sm table-hover mb-0" style="font-size: 0.82rem;">
                                    <thead class="table-light">
                                        <tr>
                                            <th class="py-2 px-3" style="width: 130px;">{{ __('Source') }}</th>
                                    ...
                                    <tbody>
                                        @foreach ($wh['items'] as $item)
                                            @php
                                                $src = $sourceLabel[$item->csource] ?? ['label' => $item->csource, 'badge' => 'bg-secondary'];
                                            @endphp
                                            <tr>
                                                {{-- Source badge --}}
                                                <td class="py-2 px-3">
                                                    <span class="badge {{ $src['badge'] }}" style="font-size: 0.72rem;">
                                                        {{ $src['label'] }}
                                                    </span>
                                                </td>
                                                ...
                                                {{-- Quantity --}}
                                                <td class="py-2 px-3 text-end fw-semibold
                                                    {{ $item->nqty < 0 ? 'text-danger' : '' }}">
